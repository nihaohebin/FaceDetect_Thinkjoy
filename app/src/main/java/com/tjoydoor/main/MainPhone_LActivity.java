...
public class MainPhone_LActivity extends Activity implements MediaPlayer.OnCompletionListener, SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Global.Varibale.isBigText) {
            setContentView(R.layout.activity_mainpad_l);
        } else {
            setContentView(R.layout.activity_mainphone_l);
        }
    ...
    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        try {
            ...
            if (mCamera == null) {
                mCamera = Camera.open(SPUtil.getInstance(MainPhone_LActivity.this).getInt(Global.Const.cameraId));
            }

            Camera.getCameraInfo(SPUtil.getInstance(MainPhone_LActivity.this).getInt(Global.Const.cameraId), cameraInfo);
            ...
            e.printStackTrace();
            ToastUtil.showMessage(MainPhone_LActivity.this, " Fail to connect to camera service");
        }
    }
        ...
        if (!isThreadWorking) {
            ...
            ServiceThreadPoolManager.getInstance().execute(new Runnable() {
                ...
                public void run() {
                    ...
                    Camera.getCameraInfo(SPUtil.getInstance(MainPhone_LActivity.this).getInt(Global.Const.cameraId), info);
...
//                                    ImageUtil.saveBitmap2file(faceCroped, TimeUtil.getCurrentTime()+".jpg");
                    ...
                    if (Global.Varibale.isFirst) {
                        ...
                        FileUtil.saveDataToFile(MainPhone_LActivity.this, "w = " + bitmap.getWidth() + "  h = " + bitmap.getHeight() + "<br>", Global.FilePath.bmpSize);
                    }

                    //只记录十次android处理时间
                    if (++Global.Varibale.saveAndroidDealTimeCount <= 10) {
                        if (Global.Varibale.isSaveAndroidDealTime) {
                            FileUtil.saveDataToFile(MainPhone_LActivity.this, (System.currentTimeMillis() - myStartTime) + "ms ", Global.FilePath.androidDealTime);
                        }
                    } else {
            ...
            switch (msg.arg1) {
                case 1:
                    ...
                    if (isPosting) {
                        ...
                        SearchManage.newInstance(MainPhone_LActivity.this).faceSearch(faceCroped, Global.Varibale.faceSetId, 1, new FaceSearchListener() {
                            @Override
...
//                                Logger.i("HTTP请求时间:" + httpTime + "ms  ");
                                ...
                                if (++Global.Varibale.saveHttpRequestTimeCount <= 10) {
                                    if (Global.Varibale.isSaveHttpRequestTime) {
                                        FileUtil.saveDataToFile(MainPhone_LActivity.this, (httpTime + "ms  "), Global.FilePath.httpTime);
                                    }
                                } else {
                                ...
                                if (error.getCode() == 0) {
                                    ...
                                    Logger.i("识别成功上一个名字 = " + lastName + "\n名 字 = " + name + "\n相似度 = " + confidence);

                                    FileUtil.saveDataToFile(MainPhone_LActivity.this, "名 字:" + name + "-----相似度：" + confidence + "---msgId：" + error.getMsg_id() + "<br>", Global.FilePath.compareResult);
            ...
            switch (msg.arg1) {
                case 1:
                    ...
                    switch (msgType) {
                        ...
                        case 0:
                            List<UserInfo> userInfos = SPUtil.getInstance(MainPhone_LActivity.this).getUserInfoList();
                            ...
                            if (null != userInfos && userInfos.size() != 0) {
                                for (UserInfo userInfo : userInfos) {
                                    ...
                                    if (userInfo.getUserName().equals(successName)) {
                                        ...
                                        if (!TextUtil.isEmpty(userInfo.getPicPath())) {
                                            GlideUtil.loadCircleImage(MainPhone_LActivity.this, userInfo.getPicPath(), ivHead);
                                        }
                                    }
                                }
                                ...
                                ToastUtil.showMessage(MainPhone_LActivity.this, "请补全该职员信息");
                            }
...
//            Logger.i( previewSizes.get(i).width + "*" + previewSizes.get(i).height);
    ...
    private void setDisplayOrientation() {
        ...
        mDisplayRotation = ScreenUtil.getDisplayRotation(MainPhone_LActivity.this);
    ...
    private void startDetect() {
        ...
        try {
            ...
            e.printStackTrace();
            ToastUtil.showMessage(MainPhone_LActivity.this, "相机启动失败");
        }
    ...
    private void doSexDetect() {
        ...
        DetectManage.newInstance(MainPhone_LActivity.this).getFaceRegion(faceCroped, true, true, new FaceRegionCheckListener() {
            @Override
