...
public class MainJiaDu_LActivity extends Activity implements OnBannerListener, SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mainjiadu_l);
        ...
        Integer[] urls = {R.raw.bg1, R.raw.bg2, R.raw.bg3};
    ...
    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        try {
            ...
            if (mCamera == null) {
                mCamera = Camera.open(SPUtil.getInstance(MainJiaDu_LActivity.this).getInt(Global.Const.cameraId));
            }

            Camera.getCameraInfo(SPUtil.getInstance(MainJiaDu_LActivity.this).getInt(Global.Const.cameraId), cameraInfo);
            ...
            e.printStackTrace();
            ToastUtil.showMessage(MainJiaDu_LActivity.this, " Fail to connect to camera service");
        }
    }
        ...
        if (!isThreadWorking) {
            ...
            ServiceThreadPoolManager.getInstance().execute(new Runnable() {
                ...
                public void run() {
                    ...
                    Camera.getCameraInfo(SPUtil.getInstance(MainJiaDu_LActivity.this).getInt(Global.Const.cameraId), info);
...
//                                    ImageUtil.saveBitmap2file(faceCroped, TimeUtil.getCurrentTime()+".jpg");
                    ...
                    if (Global.Varibale.isFirst) {
                        ...
                        FileUtil.saveDataToFile(MainJiaDu_LActivity.this, "w = " + bitmap.getWidth() + "  h = " + bitmap.getHeight() + "<br>", Global.FilePath.bmpSize);
                    }

                    //只记录十次android处理时间
                    if (++Global.Varibale.saveAndroidDealTimeCount <= 10) {
                        if (Global.Varibale.isSaveAndroidDealTime) {
                            FileUtil.saveDataToFile(MainJiaDu_LActivity.this, (System.currentTimeMillis() - myStartTime) + "ms ", Global.FilePath.androidDealTime);
                        }
                    } else {
            ...
            switch (msg.arg1) {
                case 1:
                    ...
                    if (isPosting) {
                        ...
                        SearchManage.newInstance(MainJiaDu_LActivity.this).faceSearch(faceCroped, Global.Varibale.faceSetId, 1, new FaceSearchListener() {
                            @Override
...
//                                Logger.i("HTTP请求时间:" + httpTime + "ms  ");
                                ...
                                if (++Global.Varibale.saveHttpRequestTimeCount <= 10) {
                                    if (Global.Varibale.isSaveHttpRequestTime) {
                                        FileUtil.saveDataToFile(MainJiaDu_LActivity.this, (httpTime + "ms  "), Global.FilePath.httpTime);
                                    }
                                } else {
                                ...
                                if (error.getCode() == 0) {
                                    ...
                                    FileUtil.saveDataToFile(MainJiaDu_LActivity.this, "名 字:" + name + "-----相似度：" + confidence + "---msgId：" + error.getMsg_id() + "<br>", Global.FilePath.compareResult);
            ...
            switch (msg.arg1) {
                case 1:
                    ...
                    switch (msgType) {
                        ...
                        case 0:
                            List<UserInfo> userInfos = SPUtil.getInstance(MainJiaDu_LActivity.this).getUserInfoList();
                            ...
                            if (null != userInfos && userInfos.size() != 0) {
                                for (UserInfo userInfo : userInfos) {
                                    ...
                                    if (userInfo.getUserName().equals(successName)) {
                                        ...
                                        if (!TextUtil.isEmpty(userInfo.getPicPath())) {
                                            GlideUtil.loadCircleImage(MainJiaDu_LActivity.this, userInfo.getPicPath(), ivHead);
                                        }
                                    }
                                }
                                ...
                                ToastUtil.showMessage(MainJiaDu_LActivity.this, "请补全该职员信息");
                            }
...
//            Logger.i( previewSizes.get(i).width + "*" + previewSizes.get(i).height);
    ...
    private void setDisplayOrientation() {
        ...
        mDisplayRotation = ScreenUtil.getDisplayRotation(MainJiaDu_LActivity.this);
    ...
    private void startDetect() {
        ...
        try {
            ...
            e.printStackTrace();
            ToastUtil.showMessage(MainJiaDu_LActivity.this, "相机启动失败");
        }
    ...
    private void doSexDetect() {
        ...
        DetectManage.newInstance(MainJiaDu_LActivity.this).getFaceRegion(faceCroped, true, true, new FaceRegionCheckListener() {
            @Override
